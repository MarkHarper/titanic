This repo contains javascript files that parse a dataset of statistics on the Titanic tragedy. The code logs a specific set of statistics to the console. 
